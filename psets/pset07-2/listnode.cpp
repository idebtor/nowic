...
// removes the first half of the list and returns the new head of the list 
// which begins with the second half of the list. If there are an odd number 
// of nodes, remove less and keep more. For example, keep 5 nodes if there 
// are 9 nodes. 
