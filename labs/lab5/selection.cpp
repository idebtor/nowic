...
// selection sort using a comparator function passed as a function pointer.
void selectionsort(int *list, int n, bool (*comp)(int x, int y)) {
  	DPRINT(cout << "selectionsort using fp...\n");
...
int main() {
	...
	cout << "Decsending order using fp: " << endl;
