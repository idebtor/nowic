...
// Creation: 2019/02/02
// 
// When we have a long list, we want to print some in the front part of the list and 
// some in the rear part of the list.  
// The show_n specifies the number of samples in either front or rear part of the list.  
// The per_line determines how many samples prints per line.
...
void printlist(int *list, int N, int show_n, int per_line) {
	if (show_n >= N / 2)
		...
		if (show_n >= N) show_n = N / 2;
		int rear_part = N - show_n;
		print(list, 0, show_n, per_line);
